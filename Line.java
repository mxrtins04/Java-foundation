...
- Check if x1 is equal to x2. If so print "this line is perpendicular to the x axis". If not
- Check if y1 is equal to y2. If so print "This line is perpendicular to the y axis". If not
